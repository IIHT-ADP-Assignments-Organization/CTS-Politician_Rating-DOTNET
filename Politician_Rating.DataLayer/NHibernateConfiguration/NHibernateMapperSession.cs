...
namespace Politician_Rating.DataLayer.NHibernateConfiguration
{
    public class NHibernateMapperSession : IMapperSession
    {
        ...
        public IQueryable<Candidate> candidate => _session.Query<Candidate>();
        ...
        public async System.Threading.Tasks.Task Save(Candidate entity)
        {
            await _session.SaveOrUpdateAsync(entity);
        }

        public async System.Threading.Tasks.Task Delete(Candidate entity)
        {
